...
- [ ] **FOUN-01**: Python 3.12 runtime with uv-managed environment and reproducible uv.lock lockfile
...
- [ ] **FOUN-05**: pyproject.toml with all dependencies pinned (pandas 2.2.3, DuckDB 1.5.1, linearmodels 7.0, etc.)
